...
<div id="quickAccess">
    <a href="/Final/registerStudent" class="nav-link">Register Students</a>
    <a href="/Final/feeCollection" class="nav-link">Fee Collection</a>
    <a href="/Final/expenseManagement" class="nav-link">Expense Management</a>
    <a href="/Final/payrollProcessing" class="nav-link">Payroll Processing</a>
